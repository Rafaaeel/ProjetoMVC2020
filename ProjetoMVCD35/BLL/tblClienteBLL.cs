...
namespace ProjetoMVCD35.BLL
{
    public class tblClienteBLL
    {
        ...
        {
            string consulta = string.Format($@"select * from tbl_clienteD35 where cpf_cliente = '{cpf}' and nome_cliente = '{nome_completo}' and nome_mae = '{nome_mae}'");
